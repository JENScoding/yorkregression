test_that("Test single values compared to what they were at the beginning", {
  ...
  expect_true(all(round(first$x_residuals, 4) == c(-0.0002, -0.0003,  0.0008, -0.0018,  0.0185, -0.0380,
                                                    0.0800, -0.2338, -0.0841, 0.8747)))
  expect_true(all(round(first$fitted_y, 4) == c(5.4799, 5.0474, 4.6150, 4.2305, 3.8942, 3.3656, 2.9811,
